...
namespace SmartNeighborhoodAPI.Services
{
    public class BlockServices
    {
        ...
        public async Task<ApiResponse<BlockDto>> AddAsync(BlockDto blockDto)
        {
            ...
            return ApiResponse<BlockDto>.Error(404, "Block not add");
        ...
        public async Task<ApiResponse<string>> DeleteAsync(int id)
        {
            ...
            if (entity == null)
                return ApiResponse<string>.Error(404, "Block Not Found");

            _context.Remove(entity);
            if (await _context.SaveChangesAsync() > 0)
                return ApiResponse<string>.Success("Block Deleted Successfully");

            return ApiResponse<string>.Error(404, "Faild To Delete the Block");
        }
        public async Task <ApiResponse<IQueryable<BlockDto>>> GetAll()
        {
            ...
            return ApiResponse<IQueryable<BlockDto>>.Error(404, "No Block Found");
        ...
        public async Task<ApiResponse<BlockDto>> GetByIdAsync(int id)
        {
           ...
           if(block == null)
                return ApiResponse<BlockDto>.Error(404, "Block Not Found");
        ...
        public async Task<ApiResponse<string>> UpdateAsync(int id ,  BlockDto blockDto)
        {
            ...
            return ApiResponse<string>.Error(500, "Faild To Update Block");
